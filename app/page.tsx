...
export default function Home() {
  ...
  const handleMouseMove = useCallback((e: MouseEvent) => {
    ...
    if (y > 0.86) setHoveredZone('blog')
    else if (overHead) setHoveredZone(null)
    else if (x < 0.5) setHoveredZone('design')
    else setHoveredZone('marketing')
  }, [])
    ...
    <>
      ...
      >
        ...
        <div className="shrink-0 flex justify-between items-center px-5 pt-5 pb-2 z-20 relative">
          <span className="font-sans font-medium text-[11px] tracking-[0.35em] uppercase" style={{ color: '#2f2f2b' }}>Portfolio · 2026</span>
          <span className="font-sans font-medium text-[11px] tracking-[0.35em] uppercase" style={{ color: '#2f2f2b' }}>Stockholm</span>
        </div>
